...
export default async function ReferralPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const howItWorks = [
    { step: 1, icon: '📝',
      ...
      desc: { en: 'Register on Toobit using our referral link to activate the 5% commission bonus for both you and the person who referred you.', 'zh-cn': '使用我们的邀请链接在Toobit注册，为您和推荐人激活5%佣金奖励。', 'zh-tw': '使用我們的邀請連結在Toobit註冊，為您和推薦人激活5%佣金獎勵。', ja: '紹介リンクを使ってToobitに登録し、5%コミッションボーナスを有効にします。', ko: '추천 링크를 사용하여 Toobit에 가입하고 5% 커미션 보너스를 활성화하세요.', es: 'Regístrate en Toobit usando nuestro enlace para activar el bono del 5%.', ar: 'سجّل في Toobit عبر رابط الإحالة لتفعيل مكافأة 10٪.' } },
    { step: 2, icon: '💱',
      ...
      desc: { en: 'Every trade you make generates trading fees. With the referral program, 5% of those fees are returned to you as a commission rebate.', 'zh-cn': '您的每笔交易都会产生交易手续费。通过推荐计划，其中5%将作为佣金返还给您。', 'zh-tw': '您的每筆交易都會產生交易手續費。透過推薦計劃，其中5%將作為佣金返還給您。', ja: '取引するたびに取引手数料が発生します。紹介プログラムでは、その5%がコミッションとして還元されます。', ko: '모든 거래에서 거래 수수료가 발생합니다. 추천 프로그램을 통해 수수료의 5%가 커미션으로 환급됩니다.', es: 'Cada operación genera comisiones. Con el programa de referidos, el 5% te es devuelto.', ar: 'كل صفقة تولّد رسوم تداول. مع برنامج الإحالة، يتم إرجاع 10٪ إليك.' } },
    { step: 3, icon: '🔗',
      ...
      desc: { en: 'Once registered, get your own referral code from the dashboard. Share it with friends and earn 5% commission on all their trading fees, paid out automatically.', 'zh-cn': '注册后，从仪表板获取您自己的邀请码。与朋友分享，自动获得他们所有交易手续费的5%佣金。', 'zh-tw': '註冊後，從儀表板獲取您自己的邀請碼。與朋友分享，自動獲得他們所有交易手續費的5%佣金。', ja: '登録後、ダッシュボードから自分の紹介コードを取得します。友人と共有して5%コミッションを獲得しましょう。', ko: '가입 후 대시보드에서 자신의 추천 코드를 받으세요. 친구와 공유하고 5% 커미션을 획득하세요.', es: 'Tras registrarte, obtén tu código de referido y compártelo para ganar 5% de comisión.', ar: 'بعد التسجيل، احصل على رمز الإحالة الخاص بك وشاركه لكسب 10٪ عمولة.' } },
  ];
    ...
    <div className="min-h-screen bg-[#0B0E11] text-white">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-gradient-to-r from-[#0B1A2E] to-[#0B0E11] rounded-2xl p-8 text-center mb-12 border border-blue-800">
          <p className="text-6xl font-bold text-[#2483FF] mb-2">5%</p>
        ...
        <section className="mb-12">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: '💰', title: { en: 'Passive Income', 'zh-cn': '被动收入', 'zh-tw': '被動收入', ja: '不労所得', ko: '패시브 인컴' }, desc: { en: 'Earn while you sleep. Your referrals trade, you earn 5%.', 'zh-cn': '睡觉时也能赚钱。推荐人交易，您赚取5%。', 'zh-tw': '睡覺時也能賺錢。推薦人交易，您賺取5%。', ja: '寝ている間にも稼げます。紹介者が取引すると5%獲得。', ko: '잠자는 동안에도 수익을 올리세요. 추천인이 거래하면 5%를 획득합니다.' } },
